...
seq_length = 50
indices, labels = get_final_indices(idx_label, end_idx, 'overlap', skip_frames=15, set_step=25, seq_length=50, per_label=True)
...
indices, labels = get_final_indices(idx_label, end_idx, 'overlap', set_step=25, seq_length=50, per_label=True)
...
#device = torch.device('cuda')
writer = SummaryWriter('runs/ResNet3D_new_data_first')
