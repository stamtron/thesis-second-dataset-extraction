...
for ep in tqdm(range(len(event_paths))):
    ...
    for f in range(len(folders)):
        ...
        # create an array to keep note of what current class is
        curClass = [0, 0, 0, 0, 0]
        ...
        if(StartExp):
            if (StartExp):
                if (forward):
                    ...
                    path_to_save = '/media/scratch/cmccaig/nsea_video_jpegs/centre/exp/'
                ...
                if (forward):
                    ...
                    path_to_save = '/media/scratch/cmccaig/nsea_video_jpegs/centre/bur/'
            ...
            # this could miss out cases where a field joint or anode occur on a free span
                ...
                if (forward):
                    ...
                    if(curClass[0]==1):    # Anode already visible
                        path_to_save = '/media/scratch/cmccaig/nsea_video_jpegs/centre/exp_and_fs/'
                        curClass = [1, 0, 1, 0, 1]
                    elif(curClass[3]==1):  # Field Joint already visible
                        path_to_save = '/media/scratch/cmccaig/nsea_video_jpegs/centre/exp_fj_fs/'
                        curClass = [0, 0, 1, 1, 1]
                    else:                  # Free Span only
                        path_to_save = '/media/scratch/cmccaig/nsea_video_jpegs/centre/exp_fs/'
                        curClass = [0, 0, 1, 0, 1]
                    ...
                    if(curClass[0]==1):    # Anode already visible
                        path_to_save = '/media/scratch/cmccaig/nsea_video_jpegs/centre/exp_and/'
                        curClass = [1, 0, 1, 0, 0]
                    elif(curClass[0]==1):  # Field Joint already visible
                        path_to_save = '/media/scratch/cmccaig/nsea_video_jpegs/centre/exp_fj/'
                        curClass = [0, 0, 1, 1, 0]
                    else:                  # Exposure only
                        path_to_save = '/media/scratch/cmccaig/nsea_video_jpegs/centre/exp/'
                        curClass = [0, 0, 1, 0, 0]
