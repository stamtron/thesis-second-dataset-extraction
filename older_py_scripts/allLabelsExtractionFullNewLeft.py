...
for ep in tqdm(range(len(event_paths))):
    ...
    for f in range(len(folders)):
        ...
        for name in glob.glob(center_video + '/*Ch1.mpg'):
        ...
        if(StartExp):
            if (StartExp):
                if (forward):
                    ...
                    path_to_save = '/media/scratch/cmccaig/nsea_video_jpegs/left/exp/'
                ...
                if (forward):
                    ...
                    path_to_save = '/media/scratch/cmccaig/nsea_video_jpegs/left/bur/'
            ...
            # this could miss out cases where a field joint or anode occur on a free span
                ...
                if (forward):
                    ...
                    if(curClass[0]==1):    # Anode already visible
                        path_to_save = '/media/scratch/cmccaig/nsea_video_jpegs/left/exp_and_fs/'
                        curClass = [1, 0, 1, 0, 1]
                    elif(curClass[3]==1):  # Field Joint already visible
                        path_to_save = '/media/scratch/cmccaig/nsea_video_jpegs/left/exp_fj_fs/'
                        curClass = [0, 0, 1, 1, 1]
                    else:                  # Free Span only
                        path_to_save = '/media/scratch/cmccaig/nsea_video_jpegs/left/exp_fs/'
                        curClass = [0, 0, 1, 0, 1]
                    ...
                    if(curClass[0]==1):    # Anode already visible
                        path_to_save = '/media/scratch/cmccaig/nsea_video_jpegs/left/exp_and/'
                        curClass = [1, 0, 1, 0, 0]
                    elif(curClass[0]==1):  # Field Joint already visible
                        path_to_save = '/media/scratch/cmccaig/nsea_video_jpegs/left/exp_fj/'
                        curClass = [0, 0, 1, 1, 0]
                    else:                  # Exposure only
                        path_to_save = '/media/scratch/cmccaig/nsea_video_jpegs/left/exp/'
                        curClass = [0, 0, 1, 0, 0]
